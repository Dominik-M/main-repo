...
public class Spielfeld extends JFrame implements ActionListener{
  ...
  private Container c;
  private JPanel mitte=new JPanel(new GridLayout(2,1));
  private JPanel mitteUnten;
  private JPanel oben=new JPanel(new GridLayout(1,11,10,10));
  private JPanel rechts=new JPanel(new GridLayout(9,1,10,10));
  private JPanel unten=new JPanel(new GridLayout(1,11,10,10));
  private JPanel links=new JPanel(new GridLayout(9,1,10,10));
  static JTextArea output=new JTextArea();
  private JScrollPane sp;
  private JButton würfel=new JButton("Würfeln");
  private JButton aktion=new JButton("Aktion");
  private int amZug=0;
  private int bank;
  ...
  // Sehr brutale Methode um die Oberfläche zu zeichnen
