...
import template.sound.LineListener.LineEvent;
...
public class Sound {
    ...
    public static final File SOUNDFILE = new File(template.utils.Constants.SOUND_DIRECTORY);
    private static final template.utils.Dictionary<File, Soundclip> soundclips = new template.utils.Dictionary<>();
