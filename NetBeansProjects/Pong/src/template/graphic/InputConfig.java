...
public class InputConfig extends javax.swing.JPanel {
    ...
    public enum Key {
        ...
        KEY_UP(KeyEvent.VK_UP), KEY_RIGHT(KeyEvent.VK_RIGHT), KEY_DOWN(KeyEvent.VK_DOWN), KEY_LEFT(
                KeyEvent.VK_LEFT), KEY_A(KeyEvent.VK_SPACE), KEY_B(KeyEvent.VK_SHIFT), KEY_SELECT(
    ...
    public static final File CONFIG_FILE = new File(Constants.DATA_DIRECTORY + Constants.INPUTCONFIG_FILENAME);
