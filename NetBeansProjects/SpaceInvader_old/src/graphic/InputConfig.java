...
public class InputConfig extends javax.swing.JPanel {
	...
	public enum Key {
		...
		ACCELERATE(KeyEvent.VK_UP),
		TURN_RIGHT(KeyEvent.VK_RIGHT),
		BRAKE(KeyEvent.VK_DOWN),
		TURN_LEFT(KeyEvent.VK_LEFT),
		SHOOT(KeyEvent.VK_SPACE),
		SPECIAL(KeyEvent.VK_SHIFT),
		LAND(KeyEvent.VK_CONTROL),
		PAUSE(KeyEvent.VK_ENTER);
