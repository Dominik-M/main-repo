...
public class Utilities
{
     ...
     * target following the official formular (see
    ...
    public static int calculateDamage(Attack att, Pokemon user, Pokemon target)
    {
        ...
        {
            IO.println(Text.NO_EFFECT_ON.toString() + target.toString(), IO.MessageType.IMPORTANT);
            return 0;
        }
        if (typfactor > 1.1)
        {
            IO.println(Text.VERY_EFFECTIVE.toString(), IO.MessageType.IMPORTANT);
        }
        else if (typfactor < 0.9)
        {
            IO.println(Text.NOT_EFFECTIVE.toString(), IO.MessageType.IMPORTANT);
        }
        // base damage
        ...
        {
            damage *= 2;
            IO.println(Text.CRITICAL_HIT, IO.MessageType.IMPORTANT);
        }
        // Z-Factor
