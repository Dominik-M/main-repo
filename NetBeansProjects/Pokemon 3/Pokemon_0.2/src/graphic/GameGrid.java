...
public class GameGrid extends MainPanel implements GameDataListener
{
     ...
     * BACK
     */
    private final InputOption POKEDEX = new InputOption(Text.POKEDEX, new Rectangle(Constants.MENU_BOUNDS.x + Constants.BORDER_SIZE, 0, Constants.GRAPHIC_WIDTH / 3, Constants.GRAPHIC_HEIGHT / 7)),
            POKEMON = new InputOption(Text.POKEMON, new Rectangle(Constants.MENU_BOUNDS.x + Constants.BORDER_SIZE, Constants.GRAPHIC_HEIGHT / 7, Constants.GRAPHIC_WIDTH / 3, Constants.GRAPHIC_HEIGHT / 7)),
            ITEMS = new InputOption(Text.ITEMS, new Rectangle(Constants.MENU_BOUNDS.x + Constants.BORDER_SIZE, 2 * Constants.GRAPHIC_HEIGHT / 7, Constants.GRAPHIC_WIDTH / 3, Constants.GRAPHIC_HEIGHT / 7)),
            PLAYER = new InputOption(Text.PLAYER, new Rectangle(Constants.MENU_BOUNDS.x + Constants.BORDER_SIZE, 3 * Constants.GRAPHIC_HEIGHT / 7, Constants.GRAPHIC_WIDTH / 3, Constants.GRAPHIC_HEIGHT / 7)),
            SAVE = new InputOption(Text.SAVE, new Rectangle(Constants.MENU_BOUNDS.x + Constants.BORDER_SIZE, 4 * Constants.GRAPHIC_HEIGHT / 7, Constants.GRAPHIC_WIDTH / 3, Constants.GRAPHIC_HEIGHT / 7)),
            OPTIONS = new InputOption(Text.OPTIONS, new Rectangle(Constants.MENU_BOUNDS.x + Constants.BORDER_SIZE, 5 * Constants.GRAPHIC_HEIGHT / 7, Constants.GRAPHIC_WIDTH / 3, Constants.GRAPHIC_HEIGHT / 7)),
            BACK = new InputOption(Text.BACK, new Rectangle(Constants.MENU_BOUNDS.x + Constants.BORDER_SIZE, 6 * Constants.GRAPHIC_HEIGHT / 7, Constants.GRAPHIC_WIDTH / 3, Constants.GRAPHIC_HEIGHT / 7));
    ...
    private void drawPlayer(Graphics2D g)
    {
        ...
        ImageIO.getSprite(img.getFile().getName()).draw(g, (WIDTH - SPOT) / 2, (HEIGHT - SPOT) / 2, 0);
    }
    ...
    private void enterSelectedMenuOption()
    {
        ...
        {
            IO.println("Pokedex nicht verfügbar", IO.MessageType.IMPORTANT);
        }
        else if (selectedOption.ID == POKEMON.ID)
        {
            MainFrame.FRAME.setMainPanel(new PokemonMenuPanel(this, false));
        }
        else if (selectedOption.ID == ITEMS.ID)
        {
            IO.println("Items nicht verfügbar", IO.MessageType.IMPORTANT);
        }
        ...
        else if (selectedOption.ID == SAVE.ID)
        {
            ...
            {
                IO.println("Spiel gesichert", IO.MessageType.IMPORTANT);
            }
        }
