...
public class InputOption {
     ...
     *
     */
    InputOption(Text text, Rectangle bounds) {
        txt = text;
        BOUNDS = bounds;
        ID = lastID++;
    }
    ...
    public void draw(Graphics g) {
        ...
        if (selected) {
            ...
            g.fillPolygon(new java.awt.Polygon(new int[]{BOUNDS.x, BOUNDS.x, BOUNDS.x + Constants.SELECTION_MARKER_SIZE}, new int[]{cY + Constants.SELECTION_MARKER_SIZE / 2, cY - Constants.SELECTION_MARKER_SIZE / 2, cY}, 3));
        }
    }
}
