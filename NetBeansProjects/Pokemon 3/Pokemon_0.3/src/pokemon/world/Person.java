...
public class Person extends Objekt
{
     ...
     * @param texte
     */
    public Person(String n, int blickrichtung, String... texte)
    {
     ...
     * @param texte
     */
    public Person(String n, int blickrichtung, Item anItem, String... texte)
    {
     ...
     * @param texte
     */
    public Person(String n, int blickrichtung, Item anItem, Color skincolor, Color clothcolor, String... texte)
    {
        super(ImageFile.TRAINER_DOWN, false);
        dialog = new LinkedList<>();
        for (String txt : texte)
        {
            dialog.add(txt);
        }
        name = n;
    ...
    public void benutzt()
    {
        ...
        {
            s.addItem(item);
            IO.println(s.toString() + " " + IO.translate("GETS") + " " + item.toString(), IO.MessageType.IMPORTANT);
            item = null;
        }
    }
