...
public class ImageIO
{
    ...
    public static final File IMAGE_CACHE_FILE = new File(utils.Constants.DATA_DIRECTORY + utils.Constants.IMAGE_CACHE_FILENAME);
    ...
    public enum ImageFile
    {
        ...
        BODEN("boden.png"),
        BLUMEN("blumen.png"),
        DACH_OBEN_LINKS("dach_ol.png"),
        DACH_OBEN_MITTE("dach_om.png"),
        DACH_OBEN_RECHTS("dach_or.png"),
        DACH_UNTEN_LINKS("dach_ul.png"),
        DACH_UNTEN_MITTE("dach_um.png"),
        DACH_UNTEN_RECHTS("dach_ur.png"),
        FENSTER("fenster.png"),
        FENSTER_LINKS("fenster_l.png"),
        FENSTER_RECHTS("fenster_r.png"),
        FENSTER_UNTEN("fenster_u.png"),
        GRAS("gras.png"),
        HAUSFENSTER_UNTEN("hausfenster.png"),
        HAUSWAND_UNTEN("hauswand_um.png"),
        HAUSECKE_UNTEN_LINKS("hausecke_ul.png"),
        HAUSECKE_UNTEN_RECHTS("hausecke_ur.png"),
        HUETTE_MITTE("huette_m.png"),
        HUETTE_MITTE_LINKS("huette_ml.png"),
        HUETTE_MITTE_RECHTS("huette_mr.png"),
        HUETTE_OBEN_LINKS("huette_ol.png"),
        HUETTE_OBEN_RECHTS("huette_or.png"),
        HUETTE_OBEN_MITTE("huette_om.png"),
        HUETTE_UNTEN_LINKS("huette_ul.png"),
        HUETTE_UNTEN_RECHTS("huette_ur.png"),
        HUETTENFENSTER("huettenfenster.png"),
        SCHILD("schild.png"),
        STEIN("stein.png"),
        STEIN2("stein2.png"),
        TUER("tuer.png"),
        TRAINER_DOWN("trainer_down.png"),
        TRAINER_RIGHT("trainer_right.png"),
        TRAINER_LEFT("trainer_left.png"),
        TRAINER_UP("trainer_up.png"),
        UFER_LINKS_MITTE("ufer_lm.png"),
        UFER_OBEN_LINKS("ufer_ol.png"),
        UFER_OBEN_MITTE("ufer_om.png"),
        UFER_OBEN_RECHTS("ufer_or.png"),
        UFER_RECHTS_MITTE("ufer_rm.png"),
        UFER_UNTEN_LINKS("ufer_ul.png"),
        UFER_UNTEN_MITTE("ufer_um.png"),
        UFER_UNTEN_RECHTS("ufer_ur.png"),
        WASSER("wasser.png"),
        WEG("weg.png"),
        WIESE("wiese.png"),
        ZAUN("zaun.png");
    ...
    public static Sprite getSprite(String name)
    {
        ...
        if (sprite == null)
        {
            // IO.makeToast("Image " + name + " is missing", IO.MessageType.ERROR);
            IO.println("Image " + name + " is missing", IO.MessageType.ERROR);
            // System.exit(1);
            sprite = sprites.get("abstract.png");
        }
        return sprite;
    }
    ...
    public static boolean initSprite(File file, boolean rotatable)
    {
        try
        {
            if (!sprites.containsKey(file.getName()))
            {
                ...
                Sprite sprite = new Sprite(file.getName(), images[0]);
    ...
    public static boolean loadData()
    {
        try
        {
            FileInputStream fis = new FileInputStream(IMAGE_CACHE_FILE);
            ObjectInputStream ois = new ObjectInputStream(fis);
            ImageCache c = (ImageCache) ois.readObject();
            fis.close();
            ois.close();
            sprites.clear();
            for (Sprite s : c.createSprites())
            {
                sprites.add(s.toString(), s);
            }
            IO.println("loaded  image cache", IO.MessageType.DEBUG);
            return true;
        } catch (Exception ex)
        {
            IO.println("failed to load image cache", IO.MessageType.ERROR);
            IO.printException(ex);
            return false;
        }
    }
    ...
    public static void storeData()
    {
        try
        {
            ...
            fos.close();
            oos.close();
            IO.println("saved image cache", IO.MessageType.DEBUG);
        } catch (Exception ex)
        {
            IO.println("failed to save image cache", IO.MessageType.ERROR);
            IO.printException(ex);
        }
    }
    ...
    public static ImageCache getCache()
    {
        ...
        {
            spriteArray[i] = sprites.getElements().get(i);
        }
        ImageCache cache = new ImageCache(spriteArray);
        return cache;
    }
}
