...
public class Settings implements java.io.Serializable, java.lang.Cloneable
{
     ...
     *
     */
    public static final File SETTINGS_FILE = new File(utils.Constants.DATA_DIRECTORY + utils.Constants.SETTINGS_FILENAME);
     ...
     *
     */
    public IO.Language preferredLanguage = Constants.DEFAULT_LANGUAGE;
