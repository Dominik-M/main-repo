...
java.awt.event.ComponentListener {
	...
	private javax.swing.JMenuItem addDirRecMenuItem;
	...
	public void init() {
		...
		addDirMenuItem = new javax.swing.JMenuItem("Add sound directory...");
		this.addDirMenuItem.addActionListener(new java.awt.event.ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				if (mainPanel.getClass() == MusicPlayerPanel.class) {
					javax.swing.JFileChooser jfc = new javax.swing.JFileChooser();
					jfc.setFileSelectionMode(javax.swing.JFileChooser.DIRECTORIES_ONLY);
					if (jfc.showDialog(FRAME, "Select Directory") == javax.swing.JFileChooser.APPROVE_OPTION) {
						((MusicPlayerPanel) mainPanel).addToLibrary(jfc.getSelectedFile(), false);
					}
				}
			}
		});
		this.menuSystem.add(this.addDirMenuItem);
		addDirRecMenuItem = new javax.swing.JMenuItem("Add directories recursive...");
		this.addDirRecMenuItem.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (mainPanel.getClass() == MusicPlayerPanel.class) {
					...
					jfc.setFileSelectionMode(javax.swing.JFileChooser.DIRECTORIES_ONLY);
					if (jfc.showDialog(FRAME, "Select Directory") == javax.swing.JFileChooser.APPROVE_OPTION) {
						((MusicPlayerPanel) mainPanel).addToLibrary(jfc.getSelectedFile(), true);
					}
				}
			}
		});
		this.menuSystem.add(this.addDirRecMenuItem);
