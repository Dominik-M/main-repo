...
public class InputConfig extends javax.swing.JPanel {
    ...
    public enum Key {
        ...
        UP(KeyEvent.VK_UP), RIGHT(KeyEvent.VK_RIGHT), DOWN(KeyEvent.VK_DOWN), LEFT(
                KeyEvent.VK_LEFT), A(KeyEvent.VK_SPACE), B(KeyEvent.VK_SHIFT), SELECT(
                        KeyEvent.VK_CONTROL), START(KeyEvent.VK_ENTER);
    ...
    public static final File CONFIG_FILE = new File(utils.Constants.INPUTCONFIG_FILENAME);
