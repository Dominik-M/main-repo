...
public class Settings implements java.io.Serializable {
    ...
    public static final File SETTINGS_FILE = new File(template.utils.Constants.SETTINGS_FILENAME);
    ...
    public java.awt.Color fontColor = Color.CYAN;
    public boolean showCloseWarning = true, loggingEnabled = true, soundOn = true,
            mouseEnabled = true, drawBounds = false, drawLifes = true;
