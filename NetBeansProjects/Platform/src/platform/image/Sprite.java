...
public class Sprite {
	 ...
	 * @param x
	 *        The x location in pixel coordinates at which to draw the sprite
	 * @param y
	 *        The y location in pixel coordinates at which to draw the sprite
	 * @param rotDegree
	 *        rotation of the image in degree
	 */
