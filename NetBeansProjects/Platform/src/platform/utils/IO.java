...
public class IO
{
    ...
    private static final Dictionary<String, String> texts = new Dictionary<String, String>();
    ...
    public static void makeToast(String msg, MessageType mType)
    {
        ...
        else if (mType == MessageType.IMPORTANT)
        {
    ...
    private static boolean saveLanguageFile(String filename)
    {
        try
        {
            ...
            {
                writer.println(key + " = " + "\"" + texts.get(key) + "\"");
            }
            writer.close();
    ...
    public static String translate(String text)
    {
        ...
        {
            Object o = Settings.get("autoKeyAdd");
            if (o != null && Boolean.class.isInstance(o) && (boolean) o)
            {
