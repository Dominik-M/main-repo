...
public class Utilities {
	...
	/**
	 * Convert an angle given in radiant to degree. Makes sure to have no multiple rotations: The returned value is
	 * always between (inclusive) 0 and 360.
	 * 
	 * @param rad
	 *        an angle in radiant.
	...
	/**
	 * Convert an angle given in degrees to radiant. Makes sure to have no multiple rotations: The returned value is
	 * always between (inclusive) 0 and 2PI.
	 * 
	 * @param degree
	 *        an angle in degrees.
