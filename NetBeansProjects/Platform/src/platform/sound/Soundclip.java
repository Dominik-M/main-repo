 ...
 * wav and midi. Note: If you want to use .mp3 files your Main Class has to extend javafx.application.Application and
 * call Application.launch() to init the toolkit.
 * 
