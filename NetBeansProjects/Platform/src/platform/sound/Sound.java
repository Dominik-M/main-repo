...
/**
 *
 * Static Sound Interface. Capable of initializing, storing and playing
 * Soundclips. Supported Soundfile formats are .wav, .mid and .mp3. Note: If you
 * want to use .mp3 files your Main Class has to extend
 * javafx.application.Application and call Application.launch() to init the
 * toolkit. Soundfiles stored in the directory destined by the constant
 * SOUNDFILE are initialized automatically on applications startup. Created
 * 10.03.2016
 *
