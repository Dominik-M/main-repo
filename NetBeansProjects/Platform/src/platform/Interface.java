...
public class Interface {
	...
	/**
	 * Initializes the Application. Loads Settings and Input configuration, initializes logging, creates missing
	 * directories, loads sounds and images from the specified directories and inititalizes default Interpreter
	 * Commands. Also displays the progress in the MainFrame instance. This method shall be called on the applications
	 * startup.
	 */
	...
	/**
	 * Exits the application. Closes logs and saves Settings and Configurations. Triggers a close event if onClose is
	 * defined.
	 */
