...
public final class Constants {
	...
	/**
	 * If DEBUG_ENABLE the application provides more detailed runtime information to the user.
	 */
	public static final boolean DEBUG_ENABLE = true;

	/**
	 * Default application language. The initial values of Text instances shall be in this language.
	 */
	...
	/**
	 * absolute screen resolution of the GUI. Screen is automatically scaled to actual component size on draw.
	 */
	...
	public enum LoopMode {
		LOOP_ALL, LOOP_NONE, LOOP_THIS;

		public LoopMode getNext() {
	...
	/**
	 * Delay in ms between GUI refreshs
	 */
